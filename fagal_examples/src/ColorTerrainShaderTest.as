package
{
	...
	public class ColorTerrainShaderTest extends TestBase
	{
		...
		{
			resourceList = [grassPath, rockPath, beachPath];
		...
		private function contextReady(event:Event):void
		{
			...
			//创建材质
			var _splats:Array = [Cast.bitmapTexture(resourceDic[beachPath]), Cast.bitmapTexture(resourceDic[grassPath]), Cast.bitmapTexture(resourceDic[rockPath])];
