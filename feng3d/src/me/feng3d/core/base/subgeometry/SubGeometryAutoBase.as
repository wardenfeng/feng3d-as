package me.feng3d.core.base.subgeometry
{
	...
	public class SubGeometryAutoBase extends SubGeometryBase
	{
		...
		public function set autoGenerateDummyUVs(value:Boolean):void
		{
			...
			invalidVAData(Context3DBufferTypeIDCommon.UV_VA_2);
		}
		...
		private function updateFaceTangents():void
		{
			...
			var posOffset:int = 0;
			var texStride:int = getVALen(Context3DBufferTypeIDCommon.UV_V);
			var texOffset:int = 0;
		...
		override protected function updateVAdata(dataTypeId:String):void
		{
			...
			switch (dataTypeId)
			{
				case Context3DBufferTypeID.NORMAL_VA_3:
					...
					break;
				case Context3DBufferTypeID.TANGENT_VA_3:
					...
					break;
				case Context3DBufferTypeIDCommon.UV_VA_2:
					if (_autoGenerateUVs)
					{
		...
		override protected function notifyVADataChanged(dataTypeId:String):void
		{
			...
			switch (dataTypeId)
			{
				case Context3DBufferTypeIDCommon.POSITION_VA_3:
					//标记面法线脏数据
					...
					//标记法线数据失效
					invalidVAData(Context3DBufferTypeID.NORMAL_VA_3);
					//标记切线数据失效
					invalidVAData(Context3DBufferTypeID.TANGENT_VA_3);
					break;
			}
		}
