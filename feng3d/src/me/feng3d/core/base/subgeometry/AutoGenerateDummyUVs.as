package me.feng3d.core.base.subgeometry
{
	...
	public class AutoGenerateDummyUVs extends Component
	{
		...
		public function set subGeometry(value:SubGeometry):void
		{
			...
			{
				subGeometry.removeEventListener(GeometryComponentEvent.GET_VA_DATA, onGetVAData);
			}
			_subGeometry = value;
			if (_subGeometry != null)
			{
				subGeometry.addEventListener(GeometryComponentEvent.GET_VA_DATA, onGetVAData);
			}
		}
		...
		protected function onBeAddedComponet(event:ComponentEvent):void
		{
			...
			subGeometry.invalidVAData(_.uv_va_2);
		}
