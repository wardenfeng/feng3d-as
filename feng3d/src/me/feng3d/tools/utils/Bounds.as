package me.feng3d.tools.utils
{
	...
	public class Bounds
	{
		...
		{
			return Vector.<Number>([minX, minY, minZ, minX, minY, maxZ, minX, maxY, minZ, minX, maxY, maxZ, maxX, minY, minZ, maxX, minY, maxZ, maxX, maxY, minZ, maxX, maxY, maxZ]);
		}
