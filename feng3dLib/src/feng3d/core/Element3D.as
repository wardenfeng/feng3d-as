package feng3d.core
{
	...
	import feng3d.core.math.MathConsts;
	import feng3d.core.math.Matrix3DUtils;
	import feng3d.events.Element3DEvent;

	/**
	 * 位移时抛出
	 *
	 * @eventType feng3d.events.Element3DEvent
	 */
	[Event(name = "positionChanged", type = "feng3d.events.Element3DEvent")]
	 ...
	 * @eventType feng3d.events.Element3DEvent
	 */
	[Event(name = "rotationChanged", type = "feng3d.events.Element3DEvent")]
	 ...
	 * @eventType feng3d.events.Element3DEvent
	 */
	[Event(name = "scaleChanged", type = "feng3d.events.Element3DEvent")]
	 ...
	 * @eventType feng3d.events.Element3DEvent
	 */
	[Event(name = "transformChanged", type = "feng3d.events.Element3DEvent")]
	 ...
	 */
	public class Element3D extends EventDispatcher
	{
		...
		private var _positionChanged:Element3DEvent;
		private var _rotationChanged:Element3DEvent;
		private var _scaleChanged:Element3DEvent;
		private var _transformChanged:Element3DEvent;
		...
		{
			if (!_positionChanged)
				_positionChanged = new Element3DEvent(Element3DEvent.POSITION_CHANGED, this);
		...
		private function notifyTransformChanged():void
		{
			if (!_transformChanged)
				_transformChanged = new Element3DEvent(Element3DEvent.TRANSFORM_CHANGED, this);
		...
		override public function addEventListener(type:String, listener:Function, useCapture:Boolean = false, priority:int = 0, useWeakReference:Boolean = false):void
		{
			...
			switch (type)
			{
				case Element3DEvent.POSITION_CHANGED:
					_listenToPositionChanged = true;
					break;
				case Element3DEvent.ROTATION_CHANGED:
					_listenToRotationChanged = true;
					break;
				case Element3DEvent.SCALE_CHANGED:
					_listenToRotationChanged = true;
					break;
			}
		}
		...
		{
			if (!_rotationChanged)
				_rotationChanged = new Element3DEvent(Element3DEvent.ROTATION_CHANGED, this);
		...
		{
			if (!_scaleChanged)
				_scaleChanged = new Element3DEvent(Element3DEvent.SCALE_CHANGED, this);
