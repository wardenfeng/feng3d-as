package me.feng3d.configs
{
	...
	{
		public static var bufferIDConfig:Dictionary;

		public static const originalConfigs:Array = [];

		public function Context3DBufferIDConfig()
		{
		}
		...
		public static function addBufferID(configs:Array):void
		{
			...
			{
				originalConfigs.push(configs[i]);
			}
		}
	}
}
