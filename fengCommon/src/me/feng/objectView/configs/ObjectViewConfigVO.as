package me.feng.objectView.configs
{
	...
	public class ObjectViewConfigVO
	{
		 ...
		 * 默认基础类型对象界面类定义
		 */
//		public var defaultBaseObjectViewClass:Class = DefaultBaseObjectView;
		public var defaultBaseObjectViewClass:Class = null;

		/**
		 * 默认对象界面类定义
		 */
//		public static var defaultObjectViewClass:Class = DefaultObjectView;
		public var defaultObjectViewClass:Class = DefaultObjectViewWithBlock;

		/**
		 * 默认对象属性界面类定义
		 */
		public var defaultObjectAttributeViewClass:Class = DefaultObjectAttributeView;

		/**
		 * 属性块默认界面
		 */
		public var defaultObjectAttributeBlockView:Class = DefaultObjectAttributeBlockView;

		/**
		 * 指定属性类型界面类定义字典（key:属性类名称,value:属性界面类定义）
		 */
		private var attributeDefaultViewClassByTypeDic:Dictionary = new Dictionary();
